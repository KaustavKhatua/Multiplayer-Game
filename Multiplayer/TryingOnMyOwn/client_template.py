...
class You(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Getting the starting position from the server.
        # self.server_ip = '127.0.0.1'
        # self.server_port = 65432
        # self.s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        # self.position = self.connect()
        # self.positiony = int(self.position.split(',')[0])
        # self.positionx = int(self.position.split(',')[1])
...
class Him(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # self.starting_postion = self.connect()
        # self.rect.centerx = int(self.starting_postion.split(',')[0])
        # self.rect.centery = int(self.starting_postion.split(',')[1])
